 ...
 */
final class Version20220317093458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE list_product DROP INDEX IDX_F05D9A0558FBEB9, ADD UNIQUE INDEX UNIQ_F05D9A0558FBEB9 (purchase_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE list_product DROP INDEX UNIQ_F05D9A0558FBEB9, ADD INDEX IDX_F05D9A0558FBEB9 (purchase_id)');
    }
}
